...
class CourseComments(models.Model):
	user = models.ForeignKey(UserProfile, verbose_name=u'所属用户', on_delete=None)
	course = models.ForeignKey(Course, verbose_name=u'所属课程', on_delete=None)
...
class UserMessage(models.Model):
	user = models.IntegerField(default=0, verbose_name=u'接收用户')  # 为0时发送给所有用户
...
class UserCourse(models.Model):
	user = models.ForeignKey(UserProfile, verbose_name=u'用户', on_delete=None)
