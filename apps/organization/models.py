...
class CourseOrg(models.Model):
	...
	city = models.ForeignKey(CityDict, verbose_name=u'所在城市', on_delete=None)
...
class Teacher(models.Model):
	...
	add_time = models.DateTimeField(default=datetime.now,
			verbose_name=u'添加时间')
	logo = models.ImageField(upload_to='teachers/%Y/%m', verbose_name=u'头像',
			max_length=100, default='')
	
	org = models.ForeignKey(CourseOrg, verbose_name=u'所属机构', on_delete=None)
